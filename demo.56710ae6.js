...
exports.path = {
  renderLine: function (path$, points, withLineTransform) {
    var line = d3.line()
...
},{"d3":"../node_modules/d3/index.js"}],"../node_modules/d3-svg-path-editor/src/dragger.js":[function(require,module,exports) {
'use strict'
Object.defineProperty(exports, '__esModule', { value: true })
var d3 = require('d3')
exports.createNodeDragger = function (_a) {
  var node$ = _a.node$,
    onDrag = _a.onDrag,
...
},{"d3":"../node_modules/d3/index.js"}],"../node_modules/d3-svg-path-editor/src/point-maths.js":[function(require,module,exports) {
'use strict'
Object.defineProperty(exports, '__esModule', { value: true })
 ...
 */
function getPointInsertionIndex (_a) {
  var point = _a.point,
    pathDistance = _a.pathDistance,
    pathNode = _a.pathNode,
    points = _a.points
  ...
  var _loop_1 = function () {
    var _a = pathNode.getPointAtLength(currentLength),
      x = _a.x,
      y = _a.y
    var distancesToPoint = points.map(function (point) {
      return distance(point, [x, y])
    })
    var minTravelToNextPoint = Math.min.apply(Math, distancesToPoint)
    if (minTravelToNextPoint < 1) {
      return {
        value: distancesToPoint.findIndex(function (d) {
...
},{}],"../node_modules/d3-svg-path-editor/src/snapper.js":[function(require,module,exports) {
'use strict'
Object.defineProperty(exports, '__esModule', { value: true })
var dom_1 = require('./dom')
var point_maths_1 = require('./point-maths')
var d3 = require('d3')
exports.createNodeSnapper = function (_a) {
 ...
 */
function createMouseMoveHandler (_a) {
  var onMouseOverActiveRegion = _a.onMouseOverActiveRegion,
    onMouseOutActiveRegion = _a.onMouseOutActiveRegion,
    path = _a.path,
    snapperLine = _a.snapperLine,
    snapperDot = _a.snapperDot
  var rendering = false
  function updateSnapper (mousePoint) {
    ...
    window.requestAnimationFrame(function getNextSnapperPoint () {
      rendering = true
      var _a = point_maths_1.findClosest(path, nextPoint),
        distance = _a.distance,
        point = _a.point,
        length = _a.pathLength
...
},{"./dom":"../node_modules/d3-svg-path-editor/src/dom.js","./point-maths":"../node_modules/d3-svg-path-editor/src/point-maths.js","d3":"../node_modules/d3/index.js"}],"../node_modules/d3-svg-path-editor/src/index.js":[function(require,module,exports) {
'use strict'
Object.defineProperty(exports, '__esModule', { value: true })
var dom_1 = require('./dom')
...
var point_maths_1 = require('./point-maths')
exports.toPointRef = function (_a) {
  var x = _a[0],
    y = _a[1]
...
function renderNodes (opts) {
  var svg$ = opts.svg$,
    ...
    getNodeEditTest = opts.getNodeEditTest,
    transformLine = opts.transformLine
  nodes.forEach(function renderNode (mp, i) {
    var _a = mp.point,
      x = _a[0],
      y = _a[1]
    if (!mp.node) {
      var node$ = dom_1.circle.append({ x: x, y: y, node$: svg$ })
    ...
    dom_1.circle.set({ x: x, y: y, node$: mp.node.node$ })
    mp.isDirty = false
  })
  dom_1.path.renderLine(
    path$,
...
exports.fromPoints = function (opts) {
  var _a = opts.historySize,
    historySize = _a === void 0 ? 25 : _a,
    _b = opts.onStateChange,
    onStateChange = _b === void 0 ? function () {} : _b,
    points = opts.points,
    svg$ = opts.svg$,
    userTestCanEditNode = opts.testCanEditNode,
    transformLine = opts.transformLine
  var internalCanEditNode
  ...
  var path$ = svg$
    ...
    .attr('fill', 'none')
  // bind node snapper
  var snapper = snapper_1.createNodeSnapper({
    onAddNode: function (_a) {
      ...
      nodes.splice(insertIndex, 0, { point: point })
      onAddHistory()
      render()
    },
    svg$: svg$,
  ...
  // edit toggling
  var setNodeVisibility = function (isVis) {
    return nodes.forEach(function (_a) {
      var node = _a.node
      return node && node.node$.attr('opacity', isVis ? 1 : 0)
    })
  }
  var disableEditing = function () {
    setNodeVisibility(false)
    internalCanEditNode = function () {
      return false
    }
    snapper.disable()
  }
  ...
  var render = function () {
    return window.requestAnimationFrame(function () {
      return renderNodes({
        ...
        render: render,
        svg$: svg$,
        getNodeEditTest: function () {
          return userTestCanEditNode || internalCanEditNode
        },
...
},{"./dom":"../node_modules/d3-svg-path-editor/src/dom.js","./dragger":"../node_modules/d3-svg-path-editor/src/dragger.js","./snapper":"../node_modules/d3-svg-path-editor/src/snapper.js","./point-maths":"../node_modules/d3-svg-path-editor/src/point-maths.js"}],"../src/index.ts":[function(require,module,exports) {
"use strict";
...
var d3_svg_path_editor_1 = require("d3-svg-path-editor");

function getPath(svg$, points) {
  var _d3_svg_path_editor_ = d3_svg_path_editor_1.fromPoints({
    points: points,
    svg$: svg$
  }),
      path$ = _d3_svg_path_editor_.path$,
      onUndo = _d3_svg_path_editor_.undo;
...
},{"d3-svg-path-editor":"../node_modules/d3-svg-path-editor/src/index.js"}],"demo.ts":[function(require,module,exports) {
"use strict";
...
var points = [[0, 0], [0, 100]];
var height = 600;
var width = 800;
var svg$ = d3.select(document.getElementById('demo')).attr('width', width).attr('height', height);

__1.getPath(svg$, points); // bindKeyEvents({ onUndo })
},{"./demo.css":"demo.css","d3":"../node_modules/d3/index.js","../":"../src/index.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
